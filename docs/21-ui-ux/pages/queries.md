...
- **Drilldowns**: `/query-detail`. Use named links; never assume every row represents the same execution.
...
| Drilldown behavior | Breadcrumb + URL context; selected entity and period stay explicit. Related routes: query-detail. |
